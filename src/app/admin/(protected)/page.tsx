      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
        {cards.map((card) => {
          ...
          return (
            ...
            >
              <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-lg bg-navy-900 text-orange-400">
                <Icon className="h-5 w-5" aria-hidden="true" />
              </div>
              <p className="font-display text-3xl font-bold text-navy-900">{card.value}</p>
              <p className="mt-1 flex items-center gap-1 text-sm font-semibold text-steel-600 group-hover:text-orange-600">
                {card.label}
