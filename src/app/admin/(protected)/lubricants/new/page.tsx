...
import { createLubricant } from "@/lib/admin-actions";
import { LubricantForm } from "@/components/admin/LubricantForm";

export default function NewLubricantPage() {
  return (
    <div>
      <Link
      ...
      <h1 className="mb-8 text-2xl font-bold text-navy-900">Thêm sản phẩm dầu nhớt mỡ</h1>
      <div className="max-w-2xl rounded-xl border border-steel-200 bg-white p-6 sm:p-8">
        <LubricantForm action={createLubricant} submitLabel="Tạo sản phẩm" />
      </div>
    </div>
  );
}
